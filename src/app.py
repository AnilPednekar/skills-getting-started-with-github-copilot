...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and play scrimmages",
    ...
    "Art Club": {
        ...
        "max_participants": 15,
        "participants": ["maria@mergington.edu", "leah@mergington.edu"]
    },
    "Drama Club": {
        "description": "Write, rehearse, and perform theatrical scenes",
